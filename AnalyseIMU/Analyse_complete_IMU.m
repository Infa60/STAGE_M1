...
origineC3D = '/Users/mathieubourgeois/Desktop/AnalyseIMU/C3DFilesIMU';
origine = '/Users/mathieubourgeois/Desktop/AnalyseIMU';
destination = fullfile(origine,'Traitement_IMU_Opensim');
...
for Indiv = 1:nIndiv
    ...
    modelPath = fullfile(origine,'XsensModel.osim');
